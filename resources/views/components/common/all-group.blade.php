<div class="container-xl mt-4">
    <form method="POST" action="{{ route('store_task') }}">
        @csrf
        <div class="d-flex">
            <input class="form-control border-success" type="text" id="textInput" name="task" placeholder="追加したいタスクを入力" aria-label="追加したいタスクを入力" autocomplete="off">
            <button type="submit" class="btn btn-success text-nowrap ms-2">追加</button>
        </div>
    </form>
